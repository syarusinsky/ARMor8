...
ARMor8VoiceState ARMor8Voice::getState()
{
	...
	state.op1ModAmount1 = m_Op1.getModulationAmount( 0 );
	state.op2ModAmount1 = m_Op1.getModulationAmount( 1 );
	state.op3ModAmount1 = m_Op1.getModulationAmount( 2 );
	state.op4ModAmount1 = m_Op1.getModulationAmount( 3 );
	...
	state.op1ModAmount2 = m_Op2.getModulationAmount( 0 );
	state.op2ModAmount2 = m_Op2.getModulationAmount( 1 );
	state.op3ModAmount2 = m_Op2.getModulationAmount( 2 );
	state.op4ModAmount2 = m_Op2.getModulationAmount( 3 );
	...
	state.op1ModAmount3 = m_Op3.getModulationAmount( 0 );
	state.op2ModAmount3 = m_Op3.getModulationAmount( 1 );
	state.op3ModAmount3 = m_Op3.getModulationAmount( 2 );
	state.op4ModAmount3 = m_Op3.getModulationAmount( 3 );
	...
	state.op1ModAmount4 = m_Op4.getModulationAmount( 0 );
	state.op2ModAmount4 = m_Op4.getModulationAmount( 1 );
	state.op3ModAmount4 = m_Op4.getModulationAmount( 2 );
	state.op4ModAmount4 = m_Op4.getModulationAmount( 3 );
